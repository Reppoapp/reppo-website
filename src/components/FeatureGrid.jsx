...
const FeatureCard = ({ title, description, icon, delay = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="group shadow-md border border-white/5 rounded-xl bg-black/30 backdrop-blur p-8 hover:scale-[1.03] hover:-translate-y-1 hover:border-white/10 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 cursor-pointer"
    >
      {/* Animated Icon */}
      <motion.div
        initial="hidden"
...
const FeatureGrid = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-background via-gray-900 to-background relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-background via-background/70 to-transparent pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Enhanced Grid with Consistent Spacing */}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center mt-12 sm:mt-16 p-6 sm:p-8 bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl sm:rounded-3xl border border-white/10 shadow-lg backdrop-blur-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-300"
        >
          <h3 className="text-xl sm:text-2xl font-bold mb-4 gradient-text">
            More than an app. It's your fitness story.
          </h3>
          <p className="text-sm sm:text-base text-gray-300 mb-6 max-w-2xl mx-auto px-2">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-[#FF3B30] to-[#2979FF] text-white font-semibold rounded-full px-6 sm:px-8 py-3 shadow-md hover:scale-105 hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 text-sm sm:text-base"
          >
