    ...
    <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-gray-800 via-gray-900 to-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
          ...
          {/* Left Column - iPhone with Profile Dashboard */}
          <motion.div
              ...
              <div className="relative w-[300px] h-[600px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-[3rem] p-2 shadow-2xl">
                ...
                <div className="w-full h-full bg-black rounded-[2.5rem] relative overflow-hidden shadow-inner">
                  ...
                  <div className="w-full h-full bg-black rounded-[2.5rem] overflow-hidden relative">
                    ...
                    {/* Dashboard Content */}
                    <div className="h-[calc(100%-1rem)] bg-gradient-to-b from-gray-900/30 to-black p-4 text-center">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="relative w-16 h-16 mx-auto mb-3">
                          <div className="absolute inset-0 bg-gradient-to-tr from-[#FF3B30] via-[#FF6B30] to-[#2979FF] rounded-full p-0.5 shadow-lg">
                            <div className="w-full h-full bg-gradient-to-br from-gray-700 to-gray-900 rounded-full flex items-center justify-center text-2xl shadow-inner relative overflow-hidden">
                              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent"></div>
                              <span className="relative z-10">🏋️‍♂️</span>
                            </div>
                          </div>
                          {/* Online status indicator */}
                          <div className="absolute bottom-0 right-0 w-4 h-4 bg-green-500 rounded-full border-2 border-black shadow-lg">
                            <div className="w-full h-full bg-green-400 rounded-full animate-pulse"></div>
                          </div>
                        </div>
                        
                        {/* Username */}
                        <h3 className="text-sm font-bold text-white mb-1">Alex Rivera</h3>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-6">
                        {stats.map((stat, index) => (
                          <div key={index} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-2">
                            <div className="text-lg mb-1">{stat.icon}</div>
                            <div className="text-sm font-bold text-white">{stat.value}</div>
                            <div className="text-[10px] text-gray-300">{stat.title}</div>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 text-left">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <h4 className="text-xs font-bold text-white mb-1">30-Day Push-Up Challenge</h4>
                            <p className="text-[10px] text-gray-300">Build upper body strength daily</p>
                          </div>
                      ...
                      <div className="mt-4 space-y-2">
                        <button className="w-full bg-gradient-to-r from-[#FF3B30] via-[#FF6B30] to-[#2979FF] text-white font-bold py-2 rounded-lg text-xs shadow-lg">
                          Follow
                        </button>
                        <button className="w-full bg-white/10 backdrop-blur-sm border border-white/30 text-white/90 font-semibold py-2 rounded-lg text-xs">
                          Message
                        </button>
                      </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h4 className="text-white font-bold mb-2 text-lg">Personal Dashboard</h4>
                  <p className="text-gray-400 leading-relaxed">Track your reps, streaks, and challenge progress in one beautiful interface.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h4 className="text-white font-bold mb-2 text-lg">Challenge Competitions</h4>
                  <p className="text-gray-400 leading-relaxed">Join community challenges and see how you rank against thousands of other athletes.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h4 className="text-white font-bold mb-2 text-lg">Social Recognition</h4>
                  <p className="text-gray-400 leading-relaxed">Get celebrated for your achievements and inspire others on their fitness journey.</p>
                </div>
              </motion.div>
            </div>
